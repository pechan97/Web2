...
namespace Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, PhoneNumber = model.PhoneNumber, Name = model.Nombre };
        ...
        public void AddRole(string id)
        {
            using (ApplicationDbContext db = new ApplicationDbContext())
            {
                ...
                //Crear el role
                var resultado2 = roleManager2.Create(new IdentityRole("Usuario"));
                var userManager2 = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(db));

                //Agregar usuario al role
                resultado2 = userManager2.AddToRole(id, "Usuario");

                //Usuario está en el role??
                var estaEnRole2 = userManager2.IsInRole(id, "Usuario");
            }
